...
int read_lables()
{
    ...
    printf("the label magic number:%i", magic_number);
    printf("the label number:%i", item_num);
    scanf("%d", &number);
...
int read_images()
{
    ...
    printf("the image magic number:%i", magic_number);
    printf("the image number:%i", images_num);
    printf("the image row:%i", rows);
    printf("the image colum:%i", cols);
    scanf("%d", &number);
