...
data.columns = [u"層別名稱",u"排板數",u"最小線徑",u"最小線距",u"出貨面積",
                ...
                u"E1廠別",u"E1線別",u"前處理",u"壓膜",u"不良率2"]
...
data[u"前處理"] = class_le9.fit_transform(data[u"前處理"])
data[u"壓膜"] = class_le10.fit_transform(data[u"壓膜"])
print u"層別名稱 Categorical classes:", class_le1.classes_
